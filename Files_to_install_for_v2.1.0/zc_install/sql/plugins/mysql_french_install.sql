...
# * @version $Id: pilou2/piloujp 2025 August 21 Modified in v2.1.0 $
#
...
UPDATE project_version SET project_version_comment = 'New Installation-v210 with French Language Pack v2.2.0', project_version_date_applied = now() WHERE project_version_key = 'Zen-Cart Main';
UPDATE project_version SET project_version_comment = 'New Installation-v210 with French Language Pack v2.2.0', project_version_date_applied = now() WHERE project_version_key = 'Zen-Cart Database';
