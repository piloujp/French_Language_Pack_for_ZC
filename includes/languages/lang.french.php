...
$define = [
    ...
    'EMPTY_CART_NO_QUOTE' => 'Oups ! Votre session a expiré ... Veuillez mettre à jour votre panier pour obtenir les frais de port actuels...',
    ...
    'ENTRY_EMAIL_NAME_CHECK_ERROR' => 'Votre nom a-t-il été correctement écrit ? Notre système nécessite un minimum de ' . ENTRY_FIRST_NAME_MIN_LENGTH . ' caractères. Veuillez essayer encore une fois.',
    ...
    'OUT_OF_STOCK_CAN_CHECKOUT' => 'Les produits marqués avec'.STOCK_MARK_PRODUCT_OUT_OF_STOCK.'sont en rupture de stock. <br> Les articles en rupture de stock seront mis en commande différée.',
