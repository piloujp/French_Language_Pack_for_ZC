...
$define = [
    'HEADING_TITLE' => 'États de Commande',
    'TABLE_HEADING_ORDERS_STATUS' => 'États de Commande',
    'TABLE_HEADING_ORDERS_STATUS_ID' => 'ID des états de Commande ',
    'TEXT_INFO_SORT_ORDER' => 'Trier par : ',
    'TEXT_INFO_ORDERS_STATUS_NAME' => 'État de commande :',
    'TEXT_INFO_INSERT_INTRO' => 'Veuillez saisir le nouvel état de commande avec ses données relatives',
    'TEXT_INFO_DELETE_INTRO' => 'Êtes-vous certain(e) de vouloir supprimer cet état de commande ?',
