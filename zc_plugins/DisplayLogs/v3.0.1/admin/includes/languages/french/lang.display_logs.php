...
$define = [
    ...
    'TEXT_MOST_RECENT' => 'le plus récent',
    'TEXT_OLDEST' => 'le plus ancien',
    'TEXT_SMALLEST' => 'le plus petit',
    'TEXT_LARGEST' => 'le plus grand',
    'TEXT_INSTRUCTIONS' => '<br><br>Les fichiers peuvent être triés par ordre croissant ou décroissant (en fonction de la date de la dernière modification ou de la taille du fichier) en cliquant sur l\'un des Liens <em>Asc</em> ou <em>Desc</em>. Cliquez sur une icône %7$s pour afficher le contenu du fichier associé. Seuls les %1$u premiers octets du fichier sélectionné seront lus; si un fichier est &quot;surdimensionné&quot;, sa <em>taille du fichier</em> sera mise en surbrillance comme <span class="bigfile">ceci</span>.<br><br>Cliquer sur le bouton <strong>Tout supprimer</strong> supprimera tous les fichiers en cours de visualisation; cliquer sur <strong>supprimer la sélection</strong> supprimera uniquement les fichiers dont les cases sont cochées.<br><br>Nous consultons actuellement les %2$s %3$u de %4$u fichiers journaux avec ces préfixes <code>%5$s</code> et qui <b>ne correspondent pas</b> à ces <code>%6$s </code>.<br>',
    ...
    'WARNING_SOME_FILES_DELETED' => 'Avertissement : Seuls% u des fichiers journaux %u ont été supprimés; vérifiez les autorisations.',
