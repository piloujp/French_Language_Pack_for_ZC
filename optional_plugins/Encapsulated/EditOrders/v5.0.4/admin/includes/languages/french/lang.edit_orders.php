...
// Adding/updating a product
    ...
    //
    // %1$s (qty), %2$s (name), %3$s (model, y compris les crochets s’ils ne sont pas vides !), %4$s (final price), %5$s (tax rate)
    //
...
// ot_coupon messages, present in the storefront main language file
    ...
    'TEXT_INVALID_COUPON_PRODUCT' => 'Le coupon « %1$s » n’est valable pour aucun des produits de votre panier.',
    'TEXT_INVALID_FINISHDATE_COUPON' => 'Le coupon "%1$s" n’est désormais plus valide (expiré le %2$s).',
    'TEXT_INVALID_REDEEM_COUPON' => 'Le code de réduction "%s" est invalide',
