...
// Admin configuration
    ...
    'CFGTITLE_ACCESSBLOCK_BLOCKED_COMPANIES' => 'Bloquer par : Entreprise',
    'CFGDESC_ACCESSBLOCK_BLOCKED_COMPANIES' => 'Veuillez indiquer, sous forme de liste séparée par des virgules, les <em>entreprises</em> pour lesquelles la création de compte es bloquée.Si le nom de l’entreprise saisi sur la page « Créer un compte » <em>contient</em> l’une des chaînes de caractères saisies ici, la création du compte sera bloquée.',
