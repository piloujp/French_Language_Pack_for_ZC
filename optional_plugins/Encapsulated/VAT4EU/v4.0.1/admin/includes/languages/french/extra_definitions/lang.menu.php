...
$define = [
    'ADMIN_PLUGIN_MANAGER_NAME_FOR_VAT4EU' => 'TVA pour les pays de l’UE',
    'ADMIN_PLUGIN_MANAGER_DESCRIPTION_FOR_VAT4EU' => 'Ce plugin met à jour votre boutique pour collecter, afficher et valider un numéro de TVA européen. Consultez le <a href="https://github.com/lat9/vat4eu/wiki" target="_blank" rel="noopener noreferrer">Wiki</a> de <em>VAT4EU</em> pour plus d’informations.',
// Admin configuration group
    'CFG_GRP_TITLE_VAT4EU_PLUGIN' => 'Plugin TVA pour les pays de l’UE',
// Admin configuration
