...
return [
    ...
    'BOX_TOOLS_IMAGE_HANDLER_UNINSTALL' => 'Désinstallation d’Image Handler<sup>5</sup>',
    'BOX_TOOLS_IMAGE_HANDLER_VIEW_CONFIG' => 'Afficher la configuration d’Image Handler<sup>5</sup>',

    // -----
    // Messages issued by /admin/includes/init_includes/init_image_handler.php
    //
    'IH_TEXT_MESSAGE_INSTALLED' => 'Image Handler<sup>5</sup>, v%s a été installé avec succès.',
    'IH_TEXT_MESSAGE_UPDATED' => 'La mise à jour d’Image Handler<sup>5</sup> v%1$s vers v%2$s a réussi.',
