...
$define = [
    'MODULE_PAYMENT_OFFSITEPAYMENT_TEXT_TITLE' => 'Facturez-moi / Payer plus tard',
    'MODULE_PAYMENT_OFFSITEPAYMENT_TEXT_DESCRIPTION' => '',
    'MODULE_PAYMENT_OFFSITEPAYMENT_TEXT_EMAIL_FOOTER' => '', // 'Nous vous enverrons par e-mail une demande de paiement pour le total de la commande.'
// Beginning of constant configuration titles and descriptions for payment module offsitepayment
    ...
    'CFGDESC_MODULE_PAYMENT_OFFSITEPAYMENT_ORDER_STATUS_ID' => 'Définissez le statut des commandes effectuées avec ce module de paiement sur cette valeur',
];
