...
$define = [
    ...
    'DBIO_PRODUCTSOPTIONSVALUES_DESCRIPTION' => 'Ce format de rapport prend en charge l’import/export de <b>tous</b> les champs de la table <code>products_options_values</code>. Utilisez ce rapport pour ajouter ou modifier des informations sur les valeurs des options de produits de votre boutique. Un enregistrement dans le fichier CSV DbIo correspond à une valeur d’option de produit <em>spécifique à une langue</em>.' .
    '<br><br>' .
    '<b>Remarques :</b>' .
    '<ol>' .
