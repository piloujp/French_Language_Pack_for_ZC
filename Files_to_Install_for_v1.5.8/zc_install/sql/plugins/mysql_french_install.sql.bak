...
UPDATE project_version SET project_version_comment = 'New Installation-v158 with French Language Pack v2.1.2', project_version_date_applied = now() WHERE project_version_key = 'Zen-Cart Main';
UPDATE project_version SET  project_version_comment = 'New Installation-v158 with French Language Pack v2.1.2', project_version_date_applied = now() WHERE project_version_key = 'Zen-Cart Database';
