...
$define = [
    'HEADING_TITLE' => 'Envoyer un e-mail aux Clients',
    'TEXT_CUSTOMER' => 'Client : ',
    'TEXT_SUBJECT' => 'Sujet : ',
    'TEXT_FROM' => 'De : ',
    'TEXT_MESSAGE' => 'Message <br>au format Text-Only : ',
    'TEXT_MESSAGE_HTML' => 'Message<br>au format Rich Text : ',
    'TEXT_ATTACHMENTS_LIST' => 'Pièces jointes : ',
