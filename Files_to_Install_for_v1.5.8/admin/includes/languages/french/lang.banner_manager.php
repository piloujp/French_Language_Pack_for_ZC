...
$define = [
    ...
    'TABLE_HEADING_BANNER_ON_SSL' => 'Voir SSL',
    ...
    'TEXT_BANNERS_ON_SSL' => 'Affichage de bannières sur les pages SSL',
    'TEXT_INFO_BANNER_ON_SSL' => '<strong>Remarque :</strong> si cette bannière s\'affiche sans erreur sur vos pages SSL, définissez cette option sur Oui. Si cette option est définie sur Non, cette bannière sera ignorée sur les pages SSL.',
    ...
    'ERROR_UNKNOWN_BANNER_ON_SSL' => 'Erreur : échec de la configuration de la bannière pour utiliser SSL',
    'TEXT_LEGEND_BANNER_ON_SSL' => 'Voir SSL',
    ...
    'IMAGE_ICON_BANNER_ON_SSL_ON' => 'Ouvrir une page sécurisée - possible',
    'IMAGE_ICON_BANNER_ON_SSL_OFF' => 'Ouvrir une page sécurisée – Impossible',
    ...
    'SUCCESS_BANNER_ON_SSL_UPDATED' => 'Succès : Le statut de la bannière qui s\'ouvre dans la page SSL a été mis à jour',
];
