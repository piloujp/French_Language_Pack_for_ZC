...
$define = [
    ...
    'EMAIL_ADVISORY' => '-----' . "\n" . '<strong>IMPORTANT:</strong> Pour votre protection et pour empêcher tout usage malveillant, tous les mails envoyés depuis ce site web sont journalisés, leur contenu enregistré et disponible pour le gérant. Si vous estimez avoir reçu cet e-mail par erreur, veuillez contacter par mail : ' . zen_config('STORE_OWNER_EMAIL_ADDRESS') . "\n\n",
