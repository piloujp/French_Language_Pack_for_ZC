...
$define = [
    ...
    'MODULE_ORDER_TOTAL_GV_INVALID_REDEEM_AMOUNT' => 'Le montant du chèque-cadeau appliqué (%s) ne peut pas être utilisé. Veuillez saisir une valeur composée uniquement de chiffres de 0 à 9 et d’un séparateur décimal, soit un point (.), soit une virgule (,).',
