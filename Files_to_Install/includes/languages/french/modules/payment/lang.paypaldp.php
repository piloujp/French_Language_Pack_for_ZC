...
$define = [
    ...
    'MODULE_PAYMENT_PAYPALDP_TEXT_JS_CC_OWNER' => '* Le nom du propriétaire de la carte doit comprendre au moins ' . zen_config('CC_OWNER_MIN_LENGTH') . ' caractères.\n',
    'MODULE_PAYMENT_PAYPALDP_TEXT_JS_CC_NUMBER' => '* Le numéro de carte de crédit doit comprendre au moins ' . zen_config('CC_NUMBER_MIN_LENGTH') . ' caractères.\n',
