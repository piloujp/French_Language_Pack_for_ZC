...
$define = [
    ...
    'MODULE_PAYMENT_AUTHORIZENET_TEXT_JS_CC_OWNER' => '* Le nom du propriétaire de la carte de crédit doit comporter au moins  ' . zen_config('CC_OWNER_MIN_LENGTH') . ' caractères.',
    'MODULE_PAYMENT_AUTHORIZENET_TEXT_JS_CC_NUMBER' => '* Le numéro de carte doit comporter au moins ' . zen_config('CC_NUMBER_MIN_LENGTH') . ' caractères.',
