...
$define = [
    ...
    'TEXT_EMAIL_SUBJECT_ADMIN_SETTINGS_CHANGED' => 'ALERTE : vos paramètres Admin ont été changés dans votre boutique en ligne.« ' . zen_config('STORE_NAME') . ' »',
    'TEXT_EMAIL_MESSAGE_ADMIN_SETTINGS_CHANGED' => 'Ceci est un mail automatique envoyé de votre boutique « ' . zen_config('STORE_NAME') . ' » pour vous alerter qu’un changement vient d’être effectué dans vos paramètres administratifs : ' . "\n\n" . 'NOTE : les paramètres Admin ont été MODIFIÉS pour le module [%1$s], par l’administrateur %2$%s.' . "\n\n" . 'Si vous n’êtes pas à l’origine de ces modifications, il est judiceux que vous vérifiez immédiatemment les paramètres.' . "\n\n" . 'Si vous êtes déjà au courant de ces changements, vous pouvez ignorer cet e-mail automatique.',
    'TEXT_EMAIL_MESSAGE_ADMIN_MODULE_INSTALLED' => 'Ceci est un mail automatique envoyé de votre boutique « ' . zen_config('STORE_NAME') . ' » pour vous alerter qu’un changement vient d’être effectué dans vos paramètres administratifs : ' . "\n\n" . 'NOTE : les paramètres Admin ont été modifiés. Le module [%1$s] a été INSTALLÉ par l’administrateur %2$s.' . "\n\n" . 'Si vous n’êtes pas à l’origine de ces modifications, il est judiceux que vous vérifiez immédiatemment les paramètres.' . "\n\n" . 'Si vous êtes déjà au courant de ces changements, vous pouvez ignorer cet e-mail automatique.',
    'TEXT_EMAIL_MESSAGE_ADMIN_MODULE_REMOVED' => 'Ceci est un mail automatique envoyé de votre boutique « ' . zen_config('STORE_NAME') . ' » pour vous alerter qu’un changement vient d’être effectué dans vos paramètres administratifs : ' . "\n\n" . 'NOTE : les paramètres Admin ont été modifiés. Le module [%1$s] a été ENLEVÉ par l’administrateur %2$s.' . "\n\n" . 'Si vous n’êtes pas à l’origine de ces modifications, il est judiceux que vous vérifiez immédiatemment les paramètres.' . "\n\n" . 'Si vous êtes déjà au courant de ces changements, vous pouvez ignorer cet e-mail automatique.',
