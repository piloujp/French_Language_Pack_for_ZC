...
$define = [
    ...
    'SUCCESS_PRODUCT_UPDATE_PRODUCTS_VIEWED' => '<strong>Réinitialisation</strong> de l’historique des vues de produits.',
    ...
    'TEXT_INFO_PRODUCTS_VIEWED_UPDATE' => '<strong>Réinitialiser l’historique de tous les produits consultés</strong><br>Remettre les compteurs de consultations de tous les produits à 0.',
    ...
    'TEXT_INFO_SET_NEXT_ORDER_NUMBER' => '<strong>Définissez le prochain numéro de commande</strong><br>NOTE : Il doit être supérieur à %u.',
