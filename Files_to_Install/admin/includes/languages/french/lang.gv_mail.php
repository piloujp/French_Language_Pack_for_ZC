...
$define = [
    ...
    'TEXT_GV_TO_REDEEM_TEXT' => 'Avec le lien suivant, vous pouvez utiliser le ' . '%%TEXT_GV_NAME%%' . "\n\n " . '%1$s%2$s' . "\n\n" . 'ou visitez' . zen_config('STORE_NAME') . " à " . HTTP_CATALOG_SERVER . DIR_WS_CATALOG . "\n" . 'et entrez le code %2$s sur la page de paiement.',
    'TEXT_GV_TO_REDEEM_HTML' => '<a href="%1$s%2$s"> Cliquez ici pour utiliser le ' . '%%TEXT_GV_NAME%%' . '</a> ou visitez <a href="' . HTTP_CATALOG_SERVER . DIR_WS_CATALOG . '">' . zen_config('STORE_NAME') . '</a> et saisissez le code <strong>%2$s</strong> sur la page de paiement.',
];
